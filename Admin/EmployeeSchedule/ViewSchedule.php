...
<?php                                     
	...
	$data = array('employeeid'=>$employeeid,'day'=>2,'month'=>$month,'year'=>$year);
...
<?php                                     
	...
	$data = array('employeeid'=>$employeeid,'day'=>3,'month'=>$month,'year'=>$year);
	curl_setopt($ch, CURLOPT_POSTFIELDS, http_build_query($data));
...
<?php                                     
	...
	$data = array('employeeid'=>$employeeid,'day'=>4,'month'=>$month,'year'=>$year);
	curl_setopt($ch, CURLOPT_POSTFIELDS, http_build_query($data));
...
<?php                                     
	...
	$data = array('employeeid'=>$employeeid,'day'=>5,'month'=>$month,'year'=>$year);
	curl_setopt($ch, CURLOPT_POSTFIELDS, http_build_query($data));
...
<?php                                     
	...
	$data = array('employeeid'=>$employeeid,'day'=>6,'month'=>$month,'year'=>$year);
	curl_setopt($ch, CURLOPT_POSTFIELDS, http_build_query($data));
...
<?php                                     
	...
	$data = array('employeeid'=>$employeeid,'day'=>7,'month'=>$month,'year'=>$year);
	curl_setopt($ch, CURLOPT_POSTFIELDS, http_build_query($data));
...
<body>
	<div class="container">
		<div class="row" style="background-color:#f2f2f4; width:140px; margin:5px;">
			...
			<div class = "col-md-4" >
				<b>Teacher ID:</b> <?php echo $employeeid ;?>
			</div>
			<br>
			<div class = "col-md-4">
