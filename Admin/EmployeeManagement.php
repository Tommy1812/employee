                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                        ...
                                        <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                            <i class="zmdi zmdi-plus"></i><a href="https://tommyemployeesmanagement.herokuapp.com/Admin/Add_New_Employee.php" style="color:white;">Add</a></button>
                                        </div>
                                    </div>
                                ...
                                <div class="table-responsive table-responsive-data2">
                                    <table class="table table-data2">
                                        ...
                                        <?php
                                            $ch = curl_init();
                                            curl_setopt($ch, CURLOPT_URL, "https://209.97.173.188:8081/EmployeesManagement/rest/EmployeesManagement/Admin/GetListEmployee/");
                                                        ...
                                                        <td>
                                                            <div class="table-data-feature" style="float:left">
                                                                <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                    <a href="https://tommyemployeesmanagement.herokuapp.com/Admin/Edit_Employee.php?id=<?=$t['id']?>" class="zmdi zmdi-edit"></a>
                                                                </button>
                                                                <button class="item" data-toggle="tooltip" data-placement="top" title="Set Deactive">
                                                                    <a href="https://tommyemployeesmanagement.herokuapp.com/Admin/Delete_Employee.php?id=<?=$t['id']?>" class="zmdi zmdi-delete"></a>
                                                                </button>
                                                            </div>
                                                        </td>
                                                    </tr>
                        ...
                        if ( isset($_POST["submitbtn"]) ) {
                            if ( isset($_FILES["file"])) {
                                ...
                                if ($_FILES["file"]["error"] > 0) {
                                    ...
                                    $ch = curl_init();
                                    curl_setopt($ch, CURLOPT_URL, "https://209.97.173.188:8081/EmployeesManagement/rest/EmployeesManagement/Admin/ImportCSV/");
                                    curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
                                    curl_setopt($ch, CURLOPT_POST, 1);
                                    curl_setopt($ch, CURLOPT_HTTPHEADER, array('Content-Type: application/x-www-form-urlencoded')); // In Java: @Consumes(MediaType.APPLICATION_FORM_URLENCODED)
