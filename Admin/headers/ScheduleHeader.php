            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="https://tommyemployeesmanagement.herokuapp.com/EmployeeManagement/Admin/EmployeeManagement.php">
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
						...
						<li>
							<a href="https://tommyemployeesmanagement.herokuapp.com/EmployeeManagement/Admin/Salary.php">
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu" style="float:right">
                                        <div class="image">
                                            <img src="images/icon/Tommy.jpg" alt="Tommy" />
                                        </div>
                                        <div class="content">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__footer">
                                                <a href="https://tommyemployeesmanagement.herokuapp.com/EmployeeManagement/Admin/AdminLogout.php">
