                ...
                <div class="section__content section__content--p30">
                    ...
                    <div class="row">
                        ...
                        <?php
                            ...
                            {                            
                                $ch = curl_init();
                                curl_setopt($ch, CURLOPT_URL, "https://209.97.173.188:8081/EmployeesManagement/rest/EmployeesManagement/Admin/AddSalary/");
                                curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
                                curl_setopt($ch, CURLOPT_POST, 1);
                                curl_setopt($ch, CURLOPT_HTTPHEADER, array('Content-Type: application/x-www-form-urlencoded')); // In Java: @Consumes(MediaType.APPLICATION_FORM_URLENCODED)

                                $data = array('EmployeeID'=>$_POST['GV_select'],'Month' => $_POST['Month_select'], 'Year' =>$_POST['Year_select'],'Total' => $_POST['Total_input']);
                                curl_setopt($ch, CURLOPT_POSTFIELDS, http_build_query($data));
                                $output = curl_exec($ch);
                                $info = curl_getinfo($ch);
                                curl_close($ch);
